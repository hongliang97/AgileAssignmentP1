...
public class Generate_Invoice {
    ...
    public Generate_Invoice() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT ORDER_ID, PROD_ID, QUANTITY, PRICE, DATE_ORDER FROM ORDER_ITEM WHERE CUST_ID = 'C0002' AND STATUS = 'UNPAID'");
            ...
            Paragraph p3 = new Paragraph("Bill to: DEF SDN BHD");
